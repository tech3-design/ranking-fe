    ...
    <div className="space-y-1.5">
      <div className="flex items-center justify-between text-xs">
        ...
        <span
          ...
          style={{ color: atLimit ? "#FF4F18" : warn ? "#f59e0b" : "inherit" }}
        >
          {used} / {max}
          {atLimit && (
            <span className="ml-1.5 inline-flex items-center gap-0.5 text-[10px] font-bold uppercase tracking-wide text-[#FF4F18]">
      ...
      <div className="h-2 rounded-full overflow-hidden bg-muted">
        <div
          ...
          style={{
            width: `${pct}%`,
            backgroundColor: atLimit ? "#FF4F18" : warn ? "#f59e0b" : "#22c55e",
          }}
        />
      </div>
    </div>
          ...
          {usage && (
            <div className="bg-card rounded-2xl p-6 border border-border space-y-5">
              <div className="flex items-center justify-between">
                ...
                {atAnyLimit && (
                  <span className="text-[11px] font-semibold text-[#FF4F18] flex items-center gap-1">
