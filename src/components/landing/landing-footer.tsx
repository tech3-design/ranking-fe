...
const SOCIAL = [
  ...
  // { href: "https://linkedin.com/in/signalor-ai", label: "LinkedIn", icon: Linkedin },
  // { href: "https://youtube.com/SignalorAI", label: "YouTube", icon: Youtube },
            ...
            <div className="min-w-0">
              ...
              <h2 className="mt-3 font-sans text-3xl font-bold leading-[1.12] tracking-tight text-foreground sm:text-4xl lg:text-[2.35rem] xl:text-5xl">
                ...
                <span className="inline-flex items-center gap-1.5 align-middle">
                  <span className="inline-flex h-8 w-8 items-center justify-center sm:h-10 sm:w-10 xl:h-12 xl:w-12 text-primary">
                    <svg viewBox="0 0 1080 1080" className="h-8 w-8 sm:h-10 sm:w-10 xl:h-12 xl:w-12 [&_path]:fill-current" aria-hidden>
