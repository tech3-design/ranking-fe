...
const PLATFORMS = [
  ...
  { key: "reddit_score" as const, label: "Reddit", color: "var(--foreground)", icon: "💬" },
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {PLATFORMS.map((p) => {
          ...
          return (
            <div key={p.key} className="rounded-2xl bg-card p-5 border border-border">
              ...
              <div className="h-2 rounded-full mb-2 bg-muted">
