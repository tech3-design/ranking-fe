...
export const INTEGRATIONS_HERO = {
  ...
  footnote: "CMS publishing · analytics ingest · webhook hooks on higher tiers",
...
export const INTEGRATIONS_FEATURE_CELLS = [
  ...
  },
  {
    ...
    mock: {
      ...
      items: [
        {
          title: "Mention drop · ChatGPT",
          meta: "Slack · #geo-alerts",
          dot: "red" as const,
          badge: "Fired",
          badgeTone: "red" as const,
        },
        {
          title: "Schema regression",
          meta: "Linear · INF-142",
          dot: "amber" as const,
          badge: "Issue",
        ...
        {
          title: "Citation recovered",
          meta: "Perplexity · email digest",
